...
const Test = () => {
  ...
  const handleSubmit = async () => {
    ...
    /*
     * Mapping answer index to actual text selection
     * if backend needs text.
     *
     * Backend test_schema:
     * Dict[str, str]
     *
    ...
    questions.forEach((q, idx) => {
      ...
      const selectedValue =
        selectedOptIdx !== undefined
          ? opts[parseInt(selectedOptIdx, 10)]
          : null;

      submitPayload.answers[
        String(q.question || `q_${idx}`)
      ] = selectedValue ?? '';
    });
      ...
      <div className="flex justify-between items-center bg-dark-800/80 p-4 rounded-xl border border-white/10 mb-8 sticky top-20 z-10 backdrop-blur-md">
        ...
        <div>
          ...
          {/* ================================================
              ...
              Non-Technical selected:
              Round 2: Non-Technical Test
              ================================================ */}
